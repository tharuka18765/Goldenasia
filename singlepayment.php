...
function getCustomerByNIC($con, $nic) {
    ...
    $stmt = $con->prepare("SELECT name, cname, customer_code, nic, loan_code, loan_amount,full_loan, loan_balance, loan_date, week_payment, due_date FROM customer WHERE nic = ? OR customer_code=? AND loan_balance != 0");
...
$updatePaymentDatesStmt->bind_param("ddssd", $paymentAmount, $newArriarse, $executiveName, $loanCode, $currentWeekNumber);
...
<div class="header-container">
    <div>
    <h3><?php echo htmlspecialchars($branchName); ?> Branch - Single Payment -  <span><?php
